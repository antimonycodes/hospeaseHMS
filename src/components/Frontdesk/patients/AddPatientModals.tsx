...
AddPatientModalProps) => {
  ...
  useEffect(() => {
    getBranches("/front-desk/branches/fetch");
    getClinicaldept("/front-desk/branches/clinical-department-fetch");
  }, []);
...
export default AddPatientModals;
