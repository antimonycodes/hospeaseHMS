...
const PharPatientDetails = () => {
  ...
  }, [patientId, getPharPatientById, getSingleReport, caseId]);
  ...
  return (
    <div className=" p-4">
      ...
      {/* Add Pharmacy Report */}
      <div className="bg-white rounded-md shadow-sm mb-4 p-6">
        <h3 className="font-medium mb-4 text-primary">Add Pharmacy Report</h3>
        <textarea
          className="w-full border border-primary rounded-md p-3 h-24 mb-4"
          placeholder="Type the pharmacy dispensing report..."
          value={reportText}
