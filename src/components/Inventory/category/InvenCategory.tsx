...
import { Edit, Loader, Loader2, XIcon } from "lucide-react";
...
const InvenCategory = ({ categorys, isLoading }: SaInventoryStockProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result =
      isEditMode && editItem
        ? await updateCategory(editItem.id, categoryData)
